...
export default function CompleteFormExample(){
    ...
    useEffect(async()=>{
      ...
      console.log(subject)
      const url = api.get.getChapters+subject.toLowerCase()+"/"
      console.log(url)
        ...
        <Row>
          <Col>
            ...
            <Row>
                ...
                className="form-group outline-1" type="textarea" name="textarea"  style={{width: '100%', height: '50%'}} /></Col>            
              ...
              <Row form>
                <Col md="6" className="form-group">
                  ...
                  <FormInput
                    onChange={(e)=>{addOptions("option1",e.target.value)}}
                    id="feEmailAddress"
                    type="text"
                ...
                <Col md="6">
                  ...
                  <FormInput
                    onChange={(e)=>{addOptions("option2",e.target.value)}}
                    id="feEmailAddress"
                    type="text"
              ...
              <Row form>
                <Col>
                  ...
                  <FormInput
                    onChange={(e)=>{addOptions("option3",e.target.value)}}
                    id="feEmailAddress"
                    type="text"
                ...
                <Col>
                  ...
                  <FormInput
                    onChange={(e)=>{addOptions("option4",e.target.value)}}
                    id="feEmailAddress"
                    type="text"
              ...
              <Row form>
                <Col md="6" className="form-group">
                  ...
                  onChange={(e)=>{addOptions("correct_answer",e.target.value)}}
                  >
                ...
                <Col md="6" className="form-group">
                  <label htmlFor="feInputState">chapters</label>
                  <FormSelect id="feInputState" 
                  onChange={(e)=>{addOptions("chapter",e.target.value)}}
                  >
                    {chapter?chapter.map((data,idx)=>{
                      return (
                        <option>
                          {data.name}
                        </option>
              ...
              <FormGroup>
                ...
                <FormInput id="feInputAddress"
                    onChange={(e)=>{addOptions("hint",e.target.value)}}
              ...
              <FormGroup>
                ...
                <FormInput
                  onChange={(e)=>{addOptions("hint2",e.target.value)}}
                  id="feInputAddress2"
              ...
              <Row form>
                <Col md="6" className="form-group">
                  ...
                  <FormSelect id="feInputState"
                  onChange={(e)=>{addOptions("difficulty",e.target.value)}}
                  >
                    <option>Choose...</option>
                    <option>1</option>
                    <option>2</option>
                ...
                <Col md="4" className="form-group">
                  ...
                  <FormSelect id="feInputState"
                  onChange={(e)=>{addOptions("exam",e.target.value)}}
                  >
                    <option>Choose...</option>
                    <option>...</option>
                ...
                <Col md="2" className="form-group">
                  ...
                  >Year</label>
                  onChange={(e)=>{addOptions("year",e.target.value)}}
                  <FormInput id="feInputEmail"  type="text" placeholder="year"/>
                </Col>
              ...
              <Button onClick={(e)=>{handleSubmit()}}>{text}</Button>
            </Form>
          </Col>
        </Row>
      </ListGroupItem>
